...
class ProductServiceTest {
    ...
    void searchByName() {
        ...
        assertEquals(
                "[SearchResult{article='A2', nameProduct='N2', finalPrice=312.50, supplierName='N2', address='A2', manufacturerName='N1'}, " +
                        "SearchResult{article='A3', nameProduct='N2_1', finalPrice=390, supplierName='N2', address='A2', manufacturerName='N1'}]",
                productService.search("2").toString());
    }
    ...
    void searchByArticle() {
        assertEquals("""
                        [SearchResult{article='A2', nameProduct='N2', finalPrice=312.50, supplierName='N2', address='A2', manufacturerName='N1'}]""",
                productService.search("A2").toString());
